...
const CheckoutConfirmationModal: React.FC<CheckoutConfirmationModalProps> = ({
  ...
  const banks: BankType[] = ['WISE', 'PAYONEER', 'CIH'];

  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      className="w-full max-w-2xl mx-auto custom-scrollbar"
      maxHeight="90vh"
    >
          ...
          <div className="flex justify-between items-center">
            {selectedPriceOption && (
              <div className="text-sm">
                ...
                <span className="font-medium">Option {parseInt(selectedPriceOption.id)}</span>
